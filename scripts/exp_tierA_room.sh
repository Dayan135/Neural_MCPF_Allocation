...
#   sbatch --dependency=afterok:<gen_job_id> scripts/exp_tierA_room.sh

#SBATCH --job-name=mcpf_tierA_room
#SBATCH --array=0-2
...
#SBATCH --mem=32G
#SBATCH --output=/home/dayanb/course_multiagent/Neural_MCPF_Allocation/logs/tierA_room_%A_%a.out
#SBATCH --error=/home/dayanb/course_multiagent/Neural_MCPF_Allocation/logs/tierA_room_%A_%a.err
...
python train.py \
    ...
    --lam 0.1 \
    --seed "$SEED" \
    --run_name "tierA_room_s${SEED}"

echo "Training complete: tierA_room_s${SEED}"
