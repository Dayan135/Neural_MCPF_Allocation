...
#   sbatch --dependency=afterok:<gen_job_id> scripts/exp_tierB_random.sh

#SBATCH --job-name=mcpf_tierB_random
#SBATCH --array=0-2
...
#SBATCH --mem=32G
#SBATCH --output=/home/dayanb/course_multiagent/Neural_MCPF_Allocation/logs/tierB_random_%A_%a.out
#SBATCH --error=/home/dayanb/course_multiagent/Neural_MCPF_Allocation/logs/tierB_random_%A_%a.err
...
python train.py \
    ...
    --lam 0.1 \
    --seed "$SEED" \
    --run_name "tierB_random_s${SEED}"

echo "Training complete: tierB_random_s${SEED}"
