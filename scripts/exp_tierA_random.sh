...
#   sbatch --dependency=afterok:<gen_job_id> scripts/exp_tierA_random.sh

#SBATCH --job-name=mcpf_tierA_random
#SBATCH --array=0-2
...
#SBATCH --mem=32G
#SBATCH --output=/home/dayanb/course_multiagent/Neural_MCPF_Allocation/logs/tierA_random_%A_%a.out
#SBATCH --error=/home/dayanb/course_multiagent/Neural_MCPF_Allocation/logs/tierA_random_%A_%a.err
...
echo "Training complete: tierA_random_s${SEED}"
