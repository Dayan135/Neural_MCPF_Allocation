...
#SBATCH --job-name=mcpf_tierA_joint
#SBATCH --array=0-2
...
#SBATCH --mem=32G
#SBATCH --output=/home/dayanb/course_multiagent/Neural_MCPF_Allocation/logs/tierA_joint_%A_%a.out
#SBATCH --error=/home/dayanb/course_multiagent/Neural_MCPF_Allocation/logs/tierA_joint_%A_%a.err
...
# All (map,N,M) configs, map-major to match gen_paper_maps_tierA_data.sh.
...
python train.py \
    ...
    --lam 0.1 \
    --seed "$SEED" \
    --run_name "tierA_joint_s${SEED}"

echo "Training complete: tierA_joint_s${SEED}"
