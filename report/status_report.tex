...
% ── Coloured callout boxes (no tcolorbox needed) ─────────────────────────────
...
\newenvironment{findingbox}[1]{%
  \par\medskip
  \setlength{\fboxsep}{9pt}\setlength{\fboxrule}{1pt}%
  \noindent\fcolorbox{successframe}{successbg}{%
    \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}%
    \textbf{\color{successframe}#1}\par\smallskip
}{%
    \end{minipage}%
  }\par\medskip
}
...
\newenvironment{warnbox}[1]{%
  \par\medskip
  \setlength{\fboxsep}{9pt}\setlength{\fboxrule}{1pt}%
  \noindent\fcolorbox{warnframe}{warnbg}{%
    \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}%
    \textbf{\color{warnframe}#1}\par\smallskip
}{%
    \end{minipage}%
  }\par\medskip
}
...
% ═════════════════════════════════════════════════════════════════════════════
\appendix
\section{Full 28-Config Pipeline Results}
% ═════════════════════════════════════════════════════════════════════════════
