...
maze, where random obstacles never reproduce corridor structure. It is the reason the final models are
...
the two curves rise together with $M$ instead of swapping order, so the gap is consistent rather
...
problem: pushed to 220 agents and 430 goals on the benchmark maps, the generalist runs
6.6--16.1$\times$ faster than the solver while staying within 9.6\% of optimal. Under batched,
